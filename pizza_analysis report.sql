...
SELECT pizza_type_id, name, coalesce(ingredients, 'Missing Data') as ingredients FROM idc_pizza.pizza_types
limit 5;
...
select p1.pizza_id, p1.size, p2.size, (p2.price - p1.price) as difference
from pizzas p1
join pizzas p2
on p1.pizza_type_id = p2.pizza_type_id and p2.size < p1.size;
